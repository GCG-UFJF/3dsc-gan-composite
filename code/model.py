...
class Model(object):
    def __init__(self, config, statistics, input_shape, batch_size, epoch_size, distorction_function, axis, weights, dataset_test, dataset_train=None, evaluate=False):
        ...
        self.distorction_function = distorction_function
        self.axis = axis
        ...
        self.distortion = Distortions(self.x, self.reconstruction, self.distorction_function, self.axis, self.weights)
